...
import persistence.Utils.hsqldb.Calculate;
...
public class CalculateGPATest extends TestCase
{
	...
	public void testMissingGrades()
	{
		...
		resultGPA = "";
		list = new ArrayList<>();
		final Student joe = new Student("123", "Joe", "123 fake st","1000");
		sc = new SC(joe, null, " ");
		list.add(sc);
		final Student mary = new Student("456", "Mary", "123 fake st","1000");
		sc = new SC(mary, null, " ");
		list.add(sc);
		resultGPA = Calculate.gpa(list);
	...
	public void testSomeInvalidGrades()
	{
		...
		list.add(sc);
		final Student sally = new Student("457", "Sally", "123 fake st","1000");
	...
	public void testBlankGrades()
	{
		...
		sc = new SC(joe, null, " ");
		list.add(sc);
		final Student bill = new Student("124", "Bill", "123 fake st","1000");
		sc = new SC(joe, null, " ");
		list.add(sc);
		final Student mary = new Student("456", "Mary", "123 fake st","1000");
		sc = new SC(mary, null, "X");
